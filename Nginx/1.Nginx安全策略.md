...
http {
    ...
    expires            $expires;
    more_set_headers   "Upstream-Name2: $proxy_host";
    ...
    lua_shared_dict  openapiv2_rediskey_mem        50m;
    ...
    ssl_certificate   conf.d/dtkcert/itgod.org.pem;
    ssl_certificate_key  conf.d/dtkcert/itgod.org.key;
...
server {
    ...
    server_name itgod.org;
    ssl_certificate     conf.d/dtkcert/itgod.org.cn.pem;
    ssl_certificate_key conf.d/dtkcert/itgod.org.key;

    access_log  /var/log/nginx/dtkapi.access.log json;
    error_log   /var/log/nginx/dtkapi.error.log;
        include public/srcache.conf;
...
#        set $srcache_v 2;
#     }
#     set_md5 $mem_key $uri$args;
#     srcache_store PUT /memc $mem_key;
...
#     access_log  /var/log/nginx/downcache.dtkapi.dataoke.com.access.log json;
...
# }
    ...
    location ~^/dtk-order/  {
        ...
        more_set_headers "Access-Control-Expose-Headers: Content-Length,Access-Control-Allow-Origin,Access-Control-Allow-Headers,Content-Type";
         rewrite ^/aaaa/(.*) /$1 break;
         proxy_pass    http://aaa;
    }
}
